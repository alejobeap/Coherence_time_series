...
p13_singular="y" # y/n. n by default
p13_singular_gauss="n" # y/n. n by default
...
p15_n_ifg_noloop_thre="500"	# default: 500 - setting this much higher than orig since we nullify them (p13_nullify_noloops)
